        ...
        <div class="dates-events">
          <div class="events-week" v-for="week in currentDates">
            <div
              ...
              @mouseover="mouseoverEvent(day, $event)"
              @mouseleave="mouseleaveEvent(day, $event)"
            >
              <p class="day-number">{{ day.monthDay }}</p>
              <div class="event-box">
                ...
                <p v-if="day.events.length > eventLimit" class="more-link" @click.stop="selectThisDay(day, $event)">+ {{ day.events[day.events.length - 1].cellIndex - eventLimit }} more</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    mouseoverEvent(day, jsEvent) {
      this.$emit('mouseoverEvent', day, jsEvent);
    },
    mouseleaveEvent(day, jsEvent) {
